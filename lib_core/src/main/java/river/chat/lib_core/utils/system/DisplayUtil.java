...
public class DisplayUtil {
    ...
    public static int dp2px(float dpValue) {
        final float scale = BaseApplication.getInstance()
                .getResources()
    ...
    public static int sp2px(float spValue) {
        final float fontScale = BaseApplication.getInstance()
                .getResources()
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) BaseApplication.getInstance()
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            int x = Integer.parseInt(field.get(obj)
                                             .toString());
            statusBarHeight = BaseApplication.getInstance()
                    .getResources()
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = BaseApplication.getInstance()
                .getResources();
