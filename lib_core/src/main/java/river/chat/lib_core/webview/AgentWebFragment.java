...
import river.chat.lib_core.webview.common.UIController;
...
//		});
    ...
    protected PermissionInterceptor mPermissionInterceptor = new PermissionInterceptor() {
        ...
        public boolean intercept(String url, String[] permissions, String action) {
            Log.i(TAG,
                  "mUrl:" + url + "  permission:" + mGson.toJson(permissions) + " action:" + action);
            return false;
        }
    };
                                           ...
                                           new DefaultDownloadImpl(getActivity(),
                                               ...
                                               protected void taskEnqueue(ResourceRequest resourceRequest) {
                                                   resourceRequest.enqueue(new DownloadListenerAdapter() {
                                                       ...
                                                       @MainThread
                                                       @Override
                                                       public void onProgress(String url,
                                                                              long downloaded,
                                                                              long length,
                                                                              long usedTime) {
                                                           super.onProgress(url,
                                                                            downloaded,
                                                                            length,
                                                                            usedTime);
                                                       }
                                                       ...
                                                       @Override
                                                       public boolean onResult(Throwable throwable,
                                                                               Uri path,
                                                                               String url,
                                                                               Extra extra) {
                                                           return super.onResult(throwable,
                                                                                 path,
                                                                                 url,
                                                                                 extra);
                                                       }
    ...
    public String getUrl() {
        String target = mWebParams.getUrl();
...
//        mAgentWeb.uploadFileResult(requestCode, resultCode, data);
    ...
    private void toCleanWebCache() {
        ...
        if (this.mAgentWeb != null) {
            ...
            Toast.makeText(getActivity(), "已清理缓存", Toast.LENGTH_SHORT)
                    .show();
...
//            AgentWebConfig.clearDiskCache(this.getContext());
    ...
    public void onDestroyView() {
        mAgentWeb.getWebLifeCycle()
                .onDestroy();
        FileCompressor.getInstance()
                .unregisterFileCompressEngine(this);
        super.onDestroyView();
    }
    ...
    protected MiddlewareWebClientBase getMiddlewareWebClient() {
        return this.mMiddleWareWebClient = new MiddlewareWebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (super.shouldOverrideUrlLoading(view,
                                                   url)) { // 执行 DefaultWebClient#shouldOverrideUrlLoading
                    return true;
                }
                // do you work
                return false;
            ...
            public boolean shouldOverrideUrlLoading(WebView view, WebResourceRequest request) {
                Log.e(TAG,
                      "MiddlewareWebClientBase#shouldOverrideUrlLoading request url:" + request.getUrl()
                              .toString());
                return super.shouldOverrideUrlLoading(view, request);
            }
...
//                                FileUtils.getExtensionByFilePath(filePath));
