package river.chat.lib_core.view.recycleview.databingding
...
fun setDivider(
    ...
    if(dividerOrientation != null
        ...
        var insetDrawable = recyclerView.context.resources.getDrawable(R.drawable.recyclerview_divider, null)
